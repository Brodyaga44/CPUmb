...
public class Gen10 implements Gen{

    private Button funcBtn;

    @Override
    public void LoadMB(Stage primaryStage) {
        InfoReader IR = new InfoReader("\"10gen\"");
    ...
    public void RAMselect(Stage primaryStage) {
        ...
        InfoReader IR2 = new InfoReader("\"ddr4\"");
        Singleton.getInstance().RAMType = "Данный процессор совместим только с ddr4";
